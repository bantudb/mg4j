...
public class DocumentIteratorBuilderVisitor extends AbstractQueryBuilderVisitor<DocumentIterator> {
	...
	public DocumentIterator visitPost( final Inclusion node, final DocumentIterator[] subNode ) {
	...
	public DocumentIterator visitPost( final Containment node, final DocumentIterator[] subNode ) {
