...
public class MSOfficeDocumentFactory extends AbstractSimpleTikaDocumentFactory {
    ...
    private static final OfficeParser OFFICE_PARSER = new OfficeParser();
    ...
    public MSOfficeDocumentFactory(Properties properties) throws ConfigurationException {
        super(properties);
    }

    public MSOfficeDocumentFactory(String[] property) throws ConfigurationException {
        super(property);
    }
