...
public class RTFDocumentFactory extends AbstractSimpleTikaDocumentFactory {
    private static final List<GreedyTikaField> FIELDS = Collections.singletonList(new GreedyTikaField(GreedyTikaField.NAME));
	private static final RTFParser RTF_PARSER = new RTFParser();
	private static final long serialVersionUID = 1L;

    public RTFDocumentFactory() {}

	public RTFDocumentFactory(Reference2ObjectMap<Enum<?>, Object> defaultMetadata) {
        super(defaultMetadata);
    }

    public RTFDocumentFactory(Properties properties) throws ConfigurationException {
        super(properties);
    }

    public RTFDocumentFactory(String[] property) throws ConfigurationException {
        super(property);
    }
