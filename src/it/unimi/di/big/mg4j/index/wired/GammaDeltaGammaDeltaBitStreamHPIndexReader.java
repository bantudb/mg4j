...
public class GammaDeltaGammaDeltaBitStreamHPIndexReader extends AbstractIndexReader {
 @SuppressWarnings("unused")
 private static final Logger LOGGER = LoggerFactory.getLogger( GammaDeltaGammaDeltaBitStreamHPIndexReader.class );
 ...
 /**
	 ...
	 */
 public GammaDeltaGammaDeltaBitStreamHPIndexReader( final BitStreamHPIndex index, final InputBitStream ibs, final InputBitStream positions ) {
  this.index = index;
 ...
 protected static final class BitStreamHPIndexReaderIndexIterator extends AbstractIndexIterator implements IndexIterator {
  ...
  private final GammaDeltaGammaDeltaBitStreamHPIndexReader parent;
