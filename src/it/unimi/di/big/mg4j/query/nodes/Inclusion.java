...
public class Inclusion implements Query {
	...
	/** A margin that will be added to the right of each interval of the second query. */
	public final int rightMargin;

	public Inclusion( final Query first, final Query second ) {
		this( first, second, 0, 0 );
	}
	
	public Inclusion( final Query first, final Query second, final int leftMargin, final int rightMargin ) {
		this.first = first;
		this.second = second;
	...
	public boolean equals( final Object o ) {
		if ( ! ( o instanceof Inclusion ) ) return false;
		final Inclusion d = (Inclusion)o;
